...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=.63\textwidth]{pic1} % left bottom right top
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=.63\textwidth,trim={0 0.5cm 0 1cm},clip]{pic2} % left bottom right top
	\end{center}
	\caption{سنسورها}
\end{figure}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=.70\textwidth]{pi-labelled-names} % left bottom right top
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=.70\textwidth]{pi3_5F00_gpio} % left bottom right top
	\end{center}
...
برای این که بتوانیم با رزبری کار کنیم نیاز به یک سیستم عامل بر روی آن داریم. برای این کار MicroSD را داخل لپ‌تاپ قرار می‌دهیم و سپس با استفاده از برنامه‌ی \lr{Rassberry Pi Imager}، \lr{ Rassberry Pi OS } را روی کارت رایت می‌کنیم.
