...
برای این که بتوانیم با رزبری کار کنیم نیاز به یک سیستم عامل بر روی آن داریم. برای این کار MicroSD را داخل لپ‌تاپ قرار می‌دهیم و سپس با استفاده از برنامه‌ی \lr{Raspberry Pi Imager}، \lr{ Raspberry Pi OS } را روی کارت رایت می‌کنیم.
