...
\begin{figure}[H]
	...
	\begin{center}
		\begin{ganttchart}[
			...
			\ganttbar[progress=25]{\rl{تکمیل سرور}}{10}{13} \\
			...
			\ganttbar[progress=40]{\rl{رسم نمودارها و قابلیت‌های اضافه}}{9}{13} \\
			...
			\ganttbar[progress=50]{\rl{اتصال و تست سنسورهای بدن}}{9}{12} \\
