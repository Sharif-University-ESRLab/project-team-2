...
دو پین \lr{GND} و \lr{3.3V} برای تغذیه مدار استفاده می‌شوند.  سه پین \lr{RA,LA,RL} برای گرفتن خروجی \lr{Lead}های متصل به بدن به صورت جداگانه استفاده می‌شوند که در این پروژه از آن‌ها استفاده‌ای نشده است. در عوض از جک \lr{3.5} میلی‌متری برای اتصال \lr{Lead}ها استفاده شده است. پین \lr{OUT} خروجی آنالوگ مدار است که با استفاده از آپ‌امپ، تقویت و کنترل شده است. پین‌های \lr{LOD-}
و
\lr{LOD+}
