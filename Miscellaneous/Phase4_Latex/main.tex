...
\begin{enumerate}
	...
	\item 
	سنسور \lr{DHT11}: این سنسور، هم دما و هم رطوبت هوا را اندازه‌گیری میکند.
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=.80\textwidth]{images/sensors-1.jpg}
	\end{center}
